...
enum
{
    APP_COLORFUL_ANIMATION_INDEX_COOL_WHITE = 0x06, // 静态冷白
    APP_COLORFUL_ANIMATION_INDEX_WARM_WHITE,        // 静态暖白
    APP_COLORFUL_ANIMATION_INDEX_RGB_JUMP,          // 三色跳变
    APP_COLORFUL_ANIMATION_INDEX_RAINBOW_JUMP,      // 七色跳变
    APP_COLORFUL_ANIMATION_INDEX_RGB_FADE,          // 三色渐变
    APP_COLORFUL_ANIMATION_INDEX_RAINBOW_FADE,      // 七色渐变
    APP_COLORFUL_ANIMATION_INDEX_RED_BREATHING, // 红色呼吸
    APP_COLORFUL_ANIMATION_INDEX_BLUE_BREATHING, // 蓝色呼吸
    APP_COLORFUL_ANIMATION_INDEX_GREEN_BREATHING, // 绿色呼吸
    APP_COLORFUL_ANIMATION_INDEX_CYAN_BREATHING, // 青色呼吸
    APP_COLORFUL_ANIMATION_INDEX_YELLOW_BREATHING, // 黄色呼吸
    APP_COLORFUL_ANIMATION_INDEX_PURPLE_BREATHING, // 紫色呼吸
    APP_COLORFUL_ANIMATION_INDEX_WHITE_BREATHING, // 白色呼吸
    
    APP_COLORFUL_ANIMATION_INDEX_COOL_WHITE_BREATHING, // 冷白呼吸
    APP_COLORFUL_ANIMATION_INDEX_WARM_WHITE_BREATHING, // 暖白呼吸
    
    APP_COLORFUL_ANIMATION_INDEX_RED_GREEN_FADE, // 红绿渐变
    APP_COLORFUL_ANIMATION_INDEX_RED_BLUE_FADE, // 红蓝渐变
    APP_COLORFUL_ANIMATION_INDEX_GREEN_BLUE_FADE, // 绿蓝渐变

    APP_COLORFUL_ANIMATION_INDEX_RAINBOW_FLASH, // 七色频闪
    APP_COLORFUL_ANIMATION_INDEX_RED_FLASH, // 红色频闪
    APP_COLORFUL_ANIMATION_INDEX_BLUE_FLASH, // 蓝色频闪
    APP_COLORFUL_ANIMATION_INDEX_GREEN_FLASH, // 绿色频闪
    APP_COLORFUL_ANIMATION_INDEX_CYAN_FLASH, // 青色频闪
    APP_COLORFUL_ANIMATION_INDEX_YELLOW_FLASH, // 黄色频闪
    APP_COLORFUL_ANIMATION_INDEX_PURPLE_FLASH, // 紫色频闪
    APP_COLORFUL_ANIMATION_INDEX_WHITE_FLASH, // 白色频闪  
};
